...
--%>
    ...
    transform: rotate(180deg)
            ...
            <body oncontextmenu="return false" class="snippet-body">
                <div class="container-fluid" ng-app="ConsultorioApp" ng-controller="medicosController as mc"> </div>
                <div class="container">
    ...
    <form class="form-acceder form-acceder-left" action="" method="post" name="form"> 
        <label for="usuario">Usuario</label> 
        <input class="form-styling" type="text" ng-model="mc.usuario">
        <label for="contraseña">Contraseña</label> 
        <input class="form-styling" type="password" ng-model="mc.contraseña"> 
    <div class="btn-animate"> <a class="btn-acceder">Acceder</a> </div>
    </form>
        
    <form class="form-registrarse form-registrarse-left" action="" method="post" name="form"> 
